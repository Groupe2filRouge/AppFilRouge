...
class CloudService():
    ...
    def __init__(self):
        ...
        self.s3_client.put_bucket_policy(Bucket="test-site-alex", Policy=bucket_policy)
    ...
    def push(self):
        ...
        html_tmp="/tmp/converter"
        os.system('rm -rf /tmp/clone')
        os.system('rm -r /tmp/converter')
